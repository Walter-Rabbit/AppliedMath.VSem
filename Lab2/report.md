...
Дана матрица проигрышей превого игрока, другими словами - это матрица выигрышей второго игрока:
...
Приведём решение к решению задачи линейного программирования. Прямая задача даст стратегию для второго игрока, так как он максимизирует свой выигрышь, а двойственная даст стратегию для первого игрока.
...
$$
\begin{cases}
7x_1 + 2x_2 + 5x_3 + 1x_4 \le 1 \\
2x_1 + 2x_2 + 3x_3 + 4x_4 \le 1 \\
5x_1 + 3x_2 + 4x_3 + 4x_4 \le 1 \\
3x_1 + 2x_2 + 1x_3 + 6x_4 \le 1 \\
...
```json
{
  "X": [0.0, 0.33333333333333337, 0.0, 0.0, 0.33333333333333337, 0.0, 0.33333333333333337, 0.0],
  "FunctionValue": 0.33333333333333337
}
```

Цена игры равна обратному значению полилинейной формы - это примерно равно $3$. А оптимальная смешанная стратегия для второго игрока - произведение цены игры на вектор решения прямой задачи, то есть $(0, 1, 0, 0)$.
...
$$
\begin{cases}
7y_1 + 2y_2 + 5y_3 + 3y_4 \ge 1 \\
2y_1 + 2y_2 + 3y_3 + 2y_4 \ge 1 \\
5y_1 + 3y_2 + 4y_3 + 1y_4 \ge 1 \\
1y_1 + 4y_2 + 4y_3 + 6y_4 \ge 1 \\
...
```json
{
  "X": [0.0, 0.0, 0.3333333333333333, 0.0, 0.6666666666666667, 0.33333333333333304, 0.0, 0.3333333333333333],
  "FunctionValue": 0.3333333333333333
}
```

Цена игры остаётся прежней, то есть $3$. А оптимальная смешанная стратегия первого игрока равна $(0, 0, 1, 0)$.

Математическое ожидание проигрыша первого игрока (выигрыша второго) в данном случае равно произведению оптимальной стратегии второго игрока на матрицу игры и на транспонированную оптимальную стратегию первого игрока.
...
Математическое ожидание проигрыша первого игрока равно $3$.
